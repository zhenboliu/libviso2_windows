...
int main (int argc, char** argv) {
  ...
  // sequence directory
  //string dir = argv[1];
  string dir = "H:\\KittiDataSet\\2011_10_03\\2011_10_03_drive_0042_sync";
  ...
  if (dir.find("2011_10_03")<string::npos)
  {
	  param.calib.f = 718.8560;
	  param.calib.cu = 607.1928;
	  param.calib.cv = 185.2157;
  }
  ...
  for (int32_t i=0; i<373; i++) {
    ...
    string left_img_file_name  = dir + "\\image_00\\data\\" + base_name;
    string right_img_file_name = dir + "\\image_01\\data\\" + base_name;
